...
### Ui decorated
<img src="https://github.com/Ashiquekk696/draggable_multi_listview/blob/master/assets/screenshots/decorated_og.gif" alt="Demo GIF" width="500" height="300"> 
...
```yaml
dependencies:
  draggable_multi_listview: 1.0.1
```
Then, run:
`
flutter pub get`  
